        ...
        return {
            opts = {
                disable_winbar_cb = function(args)
                    return not require("astronvim.utils.buffer").is_valid(args.buf) or status.condition.buffer_matches(
                        {
            ...
            { -- file tree padding
                condition = function(self)
                    ...
                    return status.condition.buffer_matches({
                        filetype = {"NvimTree", "OverseerList", "aerial", "dap%-repl", "dapui_.", "edgy", "neo%-tree",
                                    "undotree"}
