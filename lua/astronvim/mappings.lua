...
local sections = {
    ...
    l = {
        desc = get_icon("ActiveLSP", 1, true) .. "LSP"
    },
    u = {
        desc = get_icon("Window", 1, true) .. "UI/UX"
    },
    b = {
        desc = get_icon("Tab", 1, true) .. "Buffers"
    },
    bs = {
        desc = get_icon("Sort", 1, true) .. "Sort Buffers"
    },
    d = {
        desc = get_icon("Debugger", 1, true) .. "Debugger"
    },
    g = {
        desc = get_icon("Git", 1, true) .. "Git"
    },
    S = {
        desc = get_icon("Session", 1, true) .. "Session"
    },
    t = {
        desc = get_icon("Terminal", 1, true) .. "Terminal"
    }
}
...
maps.n["<leader>pA"] = {
    "<cmd>AstroUpdate<cr>",
    desc = "AstroNvim Update"
}
maps.n["<leader>pv"] = {
    "<cmd>AstroVersion<cr>",
    desc = "AstroNvim Version"
}
maps.n["<leader>pl"] = {
    ...
    if vim.fn.executable "lazygit" == 1 then
        ...
        maps.n["<leader>gg"] = {
            function()
                ...
                local flags =
                    worktree and (" --work-tree=%s --git-dir=%s"):format(worktree.toplevel, worktree.gitdir) or ""
